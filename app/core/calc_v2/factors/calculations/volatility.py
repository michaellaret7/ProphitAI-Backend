...
from app.core.calc_v2.factors.config import VOL_1Y_WINDOW, VOL_3M_WINDOW
from app.core.calc_v2.risk.benchmark import (
    calc_beta as _calc_beta,
    calc_idiosyncratic_vol as _calc_idiosyncratic_vol,
)
from app.core.calc_v2.risk.drawdown import calc_max_drawdown as _calc_max_drawdown
from app.core.calc_v2.technicals.volatility import calc_close_to_close_volatility
