...
Usage:
    from app.core.calculations.portfolio_allocator import run, allocate, PortfolioAllocator
...
from app.core.calculations.portfolio_allocator.service import allocate, run
from app.core.calculations.portfolio_allocator.classifier import (
    classify_tickers,
    build_classified_tickers,
    auto_adjust_bucket_targets,
)
from app.core.calculations.portfolio_allocator.strategies import STRATEGIES, run_strategy
