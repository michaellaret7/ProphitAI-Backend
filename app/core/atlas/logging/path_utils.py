"""Path utilities for agents.

Creates per-run output directories consistent with agent behavior but
...
def get_project_root() -> Path:
    ...
    """
    # From path_utils.py location: go up 5 levels to reach project root
    # logging/ -> atlas/ -> core/ -> app/ -> ProphitAI/
