...
def stringify_for_llm(obj: Any) -> str:
    ...
    Handles Pydantic models, dataclasses, and other objects by converting
...
def build_plan_context(agent: 'DeepAgent', is_first_execution: bool = False) -> str:
    ...
    context += "1. Thinking step, 'Thinking:' (detailed analytical thinking/reasoning: what and why)\n"
    ...
    context += "4. Analyze tool result (detailed analytical thinking/reasoning: findings → implication → next step)\n"
    ...
    context += "**!!! CRITICAL RULES [If you break any of these rules, you will be penalized harshly]:**\n\n"
