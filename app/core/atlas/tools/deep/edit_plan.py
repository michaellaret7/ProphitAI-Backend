"""Edit plan tool - dynamically modify execution plans."""

from typing import Optional, Literal
import re

from app.core.atlas.models import Plan, TaskStatus, PlanTask, PlanSubtask
...
def create_edit_plan_wrapper(agent):
    ...
    from app.core.atlas.logging import write_task_state_to_file
