...
@with_session('market')
def get_stock_grades_individual(ticker: str, *, start: Optional[datetime] = None, end: Optional[datetime] = None, session=None) -> Dict[str, Any]:
...
@with_session('market')
def get_ratings(ticker: str, *, start: Optional[datetime] = None, end: Optional[datetime] = None, session=None) -> Dict[str, Any]:
...
@with_session('market')
def get_analyst_recommendations(ticker: str, *, start: Optional[datetime] = None, end: Optional[datetime] = None, session=None) -> Dict[str, Any]:
...
@with_session('market')
def get_price_target_summary(ticker: str, session=None) -> Dict[str, Any]:
