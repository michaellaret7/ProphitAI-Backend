...
- `[WEB]` - web_search / web_extract / Parallel AI (raw web excerpts or full-page markdown - treat as unverified)
- `[INFERRED]` - your own calculation or interpretation

**Treat web search results as unverified.** The `web_search` tool returns ranked URLs with page excerpts retrieved by Parallel AI, not authoritative source documents. `web_extract` returns deeper full-page markdown but is still web content. Figures from web search/extract are especially error-prone for:
