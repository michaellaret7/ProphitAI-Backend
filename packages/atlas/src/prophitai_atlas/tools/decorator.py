...
def agent_tool(func: Any = None, *, name: str | None = None, category: str | None = None) -> Any:
    ...
    def _wrap(fn: Any) -> Any:
        ...
        if validators:
            ...
            _validated.category = category  # type: ignore[attr-defined]
            return _validated
        ...
        _safe.category = category  # type: ignore[attr-defined]
        return _safe
