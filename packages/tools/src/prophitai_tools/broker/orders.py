...
from prophitai_data.clients.snaptrade import get_snaptrade_broker, resolve_snaptrade_credentials
...
def get_orders(
    ...
    try:
        ...
        return success_response([r.model_dump() for r in records])
    except Exception as e:
...
@agent_tool(name="get_quotes", category="broker")
def get_quotes(
    symbols: str,
) -> str:
    """
