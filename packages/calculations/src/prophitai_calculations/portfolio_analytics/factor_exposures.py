...
from prophitai_calculations.config import UNIVERSE_TICKERS
from prophitai_calculations.factors.calc_all import calc_all_factors
from prophitai_calculations.models.factors import (
    TickerFactors,
    FactorExposureDetail,
    PortfolioFactorExposure,
)
from prophitai_calculations.utils import winsorize_series, zscore_series
from prophitai_shared.time_utils import get_utc_date_str, get_utc_days_ago
...
def _load_from_redis(date_key: str) -> dict[str, TickerFactors] | None:
    ...
    try:
        from prophitai_api.redis.sync_client import sync_cache
    except ImportError:
        return None
