...
(EventDrivenBacktest vs. LiveRunner) and the ``ExecutionModel`` embedded
in the Algorithm differ.
"""
...
class Algorithm:
    ...
    Attributes:
        ...
        execution: ExecutionModel. ``SimulatedExecutionModel`` for
            backtest, ``BrokerExecutionModel`` for live.
