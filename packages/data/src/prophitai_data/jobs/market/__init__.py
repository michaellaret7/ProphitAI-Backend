...
Usage:
    from prophitai_data.jobs.market import UpdateTickerTable, UpdatePriceTable
...
from prophitai_data.jobs.market.ticker import UpdateTickerTable
from prophitai_data.jobs.market.price import (
    UpdatePriceTable,
