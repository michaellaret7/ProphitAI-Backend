...
from prophitai_data.db.models.market import Ticker, EarningsTranscript
...
def run():
    """Fix all transcript period formatting."""
    fix_all_transcript_periods(dry_run=False)


def run_dry():
    """Simulate transcript period fixes without making changes."""
    fix_all_transcript_periods(dry_run=True)
