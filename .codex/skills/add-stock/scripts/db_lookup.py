"""DB lookup helpers for the add-stock skill."""
...
def get_stock_classifications() -> dict:
    """
    Pull all distinct sector, industry, and sub_industry values
    from the tickers table for non-ETF equities.
...
if __name__ == "__main__":
    ...
    if action == "check":
        ...
        print(json.dumps(get_stock_classifications(), indent=2))
