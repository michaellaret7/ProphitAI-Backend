...
```bash
source .venv/bin/activate && python .codex/skills/add-stock/scripts/db_lookup.py check <TICKER>
```
...
```bash
source .venv/bin/activate && python .codex/skills/add-stock/scripts/db_lookup.py classifications
```
