...
Examples:
    python init_skill.py my-skill                                    # Creates ~/.codex/skills/my-skill/
...
Examples:
  ...
  %(prog)s my-skill --resources scripts,references,assets --examples
    ...
    parser.add_argument(
        "--path",
        default=os.path.expanduser("~/.codex/skills"),
        help="Output path for the skill directory (default: ~/.codex/skills/)"
    )
    parser.add_argument(
        "--resources",
        default="",
