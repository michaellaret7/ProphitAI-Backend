...
Legacy code may still import the previous module paths (``src.phaseOne`` or
``src.phaseTwo``).  A lightweight shim registers these dotted names in
...
_phase_one_pkg = importlib.import_module("src.portfolio_optimization.phase_one")
_phase_two_pkg = importlib.import_module("src.portfolio_optimization.phase_two")
...
sys.modules.setdefault(
    ...
    importlib.import_module("src.portfolio_optimization.phase_two.phase_two_calculations"),
)
sys.modules.setdefault(
    "src.phaseTwo.retrieve_fundamental_report",
    importlib.import_module("src.portfolio_optimization.phase_two.retrieve_fundamental_report"),
)
sys.modules.setdefault(
    "src.phaseTwo.phaseTwo",
    importlib.import_module("src.portfolio_optimization.phase_two.phase_two_run"),
)
sys.modules.setdefault(
