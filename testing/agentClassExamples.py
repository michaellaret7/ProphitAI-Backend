...
class ReactAgent:
    def __init__(self, llm: str, api_key: Optional[str] = None, max_iterations: int = 10):
        ...
        self.system_prompt = """
You are a **Senior Portfolio Risk-Analyst Agent**.
...
First, you will make a to-do list of tasks needed to answer this query and how you will systemically approach the query.
