...
def get_orders(
    ...
    """
    Get orders for a user via SnapTrade's real-time orders endpoint.
...
def get_activities(
    ...
    """
    Get settled BUY/SELL trade activity from SnapTrade's daily-cached ledger.
...
def get_portfolio_performance(clerk_id: str) -> Dict[str, Any]:
    ...
    """
    from prophitai_api.services.portfolio.returns import PortfolioReturnsService
