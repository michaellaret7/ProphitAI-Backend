"""Agent Execution Session Service for managing agent runs with WebSocket streaming.
...
from prophitai_api.services.sessions.connection_manager import connection_manager
...
async def run_agent_background(
    ...
    """
    from prophitai_atlas.models import AgentResponse
