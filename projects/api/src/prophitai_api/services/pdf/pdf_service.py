...
from prophitai_api.controllers.foundry.helpers.s3_upload import S3_BUCKET, get_s3_client
from prophitai_api.services.pdf.pdf_template import build_footer_template, build_pdf_html
