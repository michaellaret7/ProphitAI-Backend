...
from prophitai_api.schemas.messaging import (
    MessageCreate,
    MessageResponse,
...
from prophitai_api.services.messaging import (
    send_message,
    get_conversations,
    get_messages,
...
from prophitai_data.repositories import messaging as messages_repo
