...
from prophitai_api.controllers.portfolio import (
...
from prophitai_data.repositories.user.account import get_all_user_data_by_clerk_id
...
class RebalancePortfolioRequest(BaseModel):
    ...
    strategy: Optional[str] = "max_sharpe"
