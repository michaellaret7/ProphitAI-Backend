...
def optimize(user_id: str, email: str):
    ...
    # Determine the correct output directory relative to this script's location
    # Script is in: ProphitAI/backend/src/portfolio_optimization/phase_one/
    # We want output in: ProphitAI/backend/output/
    script_dir = os.path.dirname(os.path.abspath(__file__))
    # To go from phase_one up to backend and then into output:
    # ../ (to portfolio_optimization) ../ (to src) ../ (to backend) output/
