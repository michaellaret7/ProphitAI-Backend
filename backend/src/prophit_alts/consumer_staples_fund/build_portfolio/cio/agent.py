...
class CIOAgent(BaseAgent):
    def __init__(self):
        super().__init__(cio_system_prompt, cio_user_prompt, max_iterations=75, plan_first=True, save_messages=True, model="gpt-4.1", verbose=True, memory_refresh_interval=8)
        
        register_cio_tools(self)

    def _initialize_semantic_memory(self):
        """Initialize CIO-specific semantic memories for risk management."""
