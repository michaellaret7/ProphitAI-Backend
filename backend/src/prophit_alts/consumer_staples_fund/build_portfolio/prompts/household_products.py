...
max_long_tickers_high_conviction = 3
...
household_products_system_prompt = f"""
<Role>
...
The industry within the Consumer Staples Sector that you will focus on is the Household Products Industry.
</Role>
...
household_products_user_prompt = f"""
<Instructions>
## PHASE 1: ANALYSIS
