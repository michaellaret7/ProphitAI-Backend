...
<List of Tickers>
{get_eligible_tickers(industry="consumer_staples_distribution_and_retail", market_cap=1_000_000_000)}
</List of Tickers>
...
- You MUST use the get_ticker_data tool for all {len(get_eligible_tickers(industry="consumer_staples_distribution_and_retail", market_cap=1_000_000_000))} tickers in the <List of Tickers>. If you do not do this, you will be VERY HARSHLY penalized.
...
2. Call get_ticker_data(ticker) for ALL {len(get_eligible_tickers(industry="consumer_staples_distribution_and_retail", market_cap=1_000_000_000))} tickers in the <List of Tickers>.
