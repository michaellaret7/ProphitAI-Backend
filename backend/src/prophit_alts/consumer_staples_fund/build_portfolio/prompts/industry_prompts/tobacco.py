...
from backend.src.db.core.prophit_alts_models import FundInitialPosition
from backend.src.db.core.db_config import MarketSession, ProphitAltsSession
...
min_short_tickers_high_conviction = 0
max_short_tickers_high_conviction = 2
min_short_tickers_low_conviction = 0
max_short_tickers_low_conviction = 2

min_long_tickers_high_conviction = 0
max_long_tickers_high_conviction = 2
min_long_tickers_low_conviction = 0
...
The industry within the Consumer Staples Sector that you will focus on is the Tobacco Industry.
</Role>
...
- IMPORTANT: Since there are not that many tickers in the Tobacco industry, you DO NOT HAVE to short any tickers. It it totally up to you what you want to short.
</Rules>
