...
max_short_tickers_high_conviction = 4
min_short_tickers_low_conviction = 1
max_short_tickers_low_conviction = 4

min_long_tickers_high_conviction = 2
max_long_tickers_high_conviction = 6
min_long_tickers_low_conviction = 1
max_long_tickers_low_conviction = 4
...
The industry within the Consumer Staples Sector that you will focus on is the Food Products Industry.
</Role>
