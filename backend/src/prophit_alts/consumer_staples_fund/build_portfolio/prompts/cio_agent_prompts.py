...
3. correlation_matrix(portfolio_dict=DICTIONARY) → Calculate correlation matrix
    a. Calculates correlation matrix using 252 trading days of historical data
    b. Shows relationships between all portfolio holdings
    c. Essential for understanding position interactions and diversification
    d. Dictionary format is: {{"ticker": {{"allocation": 0.05, "position": "long|short"}}}}
