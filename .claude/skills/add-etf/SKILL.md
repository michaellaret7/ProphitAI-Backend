...
```bash
source .venv/bin/activate && python .claude/skills/add-etf/scripts/db_lookup.py check <TICKER>
```
...
```bash
source .venv/bin/activate && python .claude/skills/add-etf/scripts/db_lookup.py classifications
```
