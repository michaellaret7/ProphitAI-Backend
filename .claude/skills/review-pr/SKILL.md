...
Deep code review of a pull request against ProphitAI's development guidelines and code quality standards defined in `.claude/CLAUDE.md`. Reports only real, actionable issues — no nitpicks, no false positives.
...
Read `.claude/CLAUDE.md` to load the full set of development guidelines. This is the source of truth for all rules.
