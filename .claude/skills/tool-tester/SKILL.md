...
The test harness script lives at `.claude/skills/tool-tester/scripts/test_harness.py`.
...
PYTHON .claude/skills/tool-tester/scripts/test_harness.py --list

# Show a tool's parameter schema
PYTHON .claude/skills/tool-tester/scripts/test_harness.py --schema ticker_performance

# Run a tool with args (args as JSON string)
PYTHON .claude/skills/tool-tester/scripts/test_harness.py ticker_performance '{"ticker": "AAPL", "years_back": 1}'
```
